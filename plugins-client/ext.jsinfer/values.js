...
var PROPER       = require('ext/jslanguage/scope_analyzer').PROPER;
var MAYBE_PROPER = require('ext/jslanguage/scope_analyzer').MAYBE_PROPER;
var NOT_PROPER   = require('ext/jslanguage/scope_analyzer').NOT_PROPER;
